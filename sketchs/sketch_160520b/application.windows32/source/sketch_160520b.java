...
public class sketch_160520b extends PApplet {
...
class GalaxyCoordinator {
    ...
    GalaxyCoordinator(PApplet _parent,float _translateX,float _translateY,float _translateZ,
...
class Stars {
    ...
    Stars(PApplet _parent,float _translateX,float _translateY,float _translateZ,
                 float _gradeX, float _gradeY, float _gradeZ,
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "sketch_160520b" };
    if (passedArgs != null) {
